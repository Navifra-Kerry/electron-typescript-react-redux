...
export default class TitleBar extends React.Component<ITitleBarProps, ITitleBarState> {
    ...
    private menu: React.RefObject<Menu> = React.createRef();
            ...
            <div className="title-bar bg-lighter-3">
                ...
                {this.state.platform === PlatformType.Windows && (
                    <div className="title-bar-menu">
                        <Menu ref={this.menu} mode="horizontal" selectable={false} triggerSubMenuAction="click" onClick={this.onMenuItemSelected}>
    ...
    private renderMenuItem = (menuItem: Electron.MenuItem, index: number) => {
        ...
        switch (itemType) {
            ...
            case 'checkbox':
                return (
                    <MenuItem key={menuItem.label} disabled={!menuItem.enabled} onClick={(e) => this.onMenuItemClick(e, menuItem)}>
    ...
    private syncTitle = (): void => {
        if (this.state.isElectron) {
            this.currentWindow.setTitle('Wellcome');
        }
    };
